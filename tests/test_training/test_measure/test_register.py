...
@pytest.mark.parametrize(
    ...
    [
        ...
        # LSTM layer has eight parameters (weight_ih_l0, weight_hh_l0, bias_ih_l0, bias_hh_l0, weight_ih_l0_reverse, weight_hh_l0_reverse, bias_ih_l0_reverse, bias_hh_l0_reverse) -> register all
        [
